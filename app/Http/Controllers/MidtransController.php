...
class MidtransController extends Controller
{
    ...
    public function payment_sewa_success(Request $request)
    {
        //INSERT
        DB::table('h_kamar')->insert([
            'user_id' => 1,
    ...
    public function payment_galon_success(Request $request)
    {
        //INSERT
        ...
        //UPDATE USER status_galon
        DB::table('user')->where('user_id', '=', Session::get('login_id'))->update([
            'status_galon' => 2 //DISEWA
        ]);
    }
    ...
    public function payment_galon_success_get(Request $request){
        //GET
        $HGalon = H_Galon::latest()->first();
