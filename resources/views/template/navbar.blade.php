        ...
        <div class="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:ps-7">
          ...
          @php
              if(Session::get('login_id')){
                echo '<a class="font-medium text-gray-500 hover:text-gray-400 sm:py-6" href="/user">Akun</a>
                      <a class="font-medium text-gray-500 hover:text-gray-400 sm:py-6" href="/user/history/kamar">Riwayat</a>
